...
Folium is a great package for embedding Leaflet apps into your Jupyter notebook and then directly to the web! Folium can generate an interactive map with just 4 lines of code. 
